...
# Association table for Many-to-Many relationship between Voyage and Passport
...
class Voyage(Base):
    ...
    passports = relationship("Passport", secondary=voyage_passport_association, back_populates="passports")
...
# --- NEW TABLE: OCR JOBS (Persist progress and results) ---
class OcrJob(Base):
    ...
    # Store results as JSON so they persist across server restarts
